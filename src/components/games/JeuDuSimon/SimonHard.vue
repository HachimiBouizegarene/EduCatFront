 ...
 <div class="border" >
    <div class="qwe">
      <div class="upleft block"  v-on:click="leftop"></div><div class="upright block"  v-on:click="rigtop"></div>  
              ...
              <div class="qwe">
      <div class="center mirectangle"  v-on:click="center"></div>  <div class="centerright mirectangle"  v-on:click="centerright"></div> 
     </div>
      <div class="qwe">
  ...
  <div class="borderregle">
    Règle du jeu:<br>
     Il faut reproduire la séquence que tu as devant toi, <br>plus tu avanceras dans le jeu plus la séquence sera difficile.<br>
    </div> 
