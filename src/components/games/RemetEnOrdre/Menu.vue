<template>
    ...
    <div class="background">
        <h1>Choisi(e) un puzzle</h1>
        <div v-for="p of puzzles" :key="p.id" class="row ">
            <div>
                <h2>{{ p.title }}</h2>
                <img :src="require(`@/assets/images/games/RemetEnOrdre/${p.image}`)">
                <div class="play">


                    <button class="favorite styled" @click="selectPuzzle(p)">Choisir</button>
                </div>
            </div>
            ...
            puzzles: [
                {
                    ...
                    id: "chimie",
                    image: "chimie.jpg",
                    title: "Symboles et outils scientifiques"
                }
            ]
        }
    },
